...
def parse_args():
    ...
    p.add_argument("--fb_dend_c", type=float, default=None,
                   help="Straight-through gain on the dendrite route in the "
                        "transported symmetric feedback "
                        "B_l = W_out·Π(w_soma+c·w_dend). Default: gamma*0.5.")
...
def main():
    ...
    print(
        f"Network: {arch_str}  STE(fb_dend_c={net.fb_dend_c:.4f})  "
